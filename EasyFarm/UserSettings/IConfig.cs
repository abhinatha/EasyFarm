...
namespace EasyFarm.UserSettings
{
    public interface IConfig
    {
        ...
        bool IsCampEnabled { get; set; }
        bool IsCampSet { get; set; }
        MemoryAPI.Navigation.Position CampPosition { get; set; }
        MemoryAPI.Zone CampZone { get; set; }
        double CampRadius { get; set; }
        BattleLists BattleLists { get; set; }
        bool ClaimedFilter { get; set; }
        double DetectionDistance { get; set; }
        int GlobalCooldown { get; set; }
        int PullCooldown { get; set; }
