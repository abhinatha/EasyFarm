...
namespace EasyFarm.UserSettings
{
    ...
    public class ProxyConfig : IConfig
    {
        ...
        {
            get => Config.Instance.IsCampEnabled;
            set => Config.Instance.IsCampEnabled = value;
        }
        public bool IsCampSet
        {
            get => Config.Instance.IsCampSet;
            set => Config.Instance.IsCampSet = value;
        }
        public MemoryAPI.Navigation.Position CampPosition
        {
            get => Config.Instance.CampPosition;
            set => Config.Instance.CampPosition = value;
        }
        public MemoryAPI.Zone CampZone
        {
            get => Config.Instance.CampZone;
            set => Config.Instance.CampZone = value;
        }
        public double CampRadius
        {
            get => Config.Instance.CampRadius;
            set => Config.Instance.CampRadius = value;
        }
        ...
        {
            get => Config.Instance.PullCooldown;
            set => Config.Instance.PullCooldown = value;
        }
